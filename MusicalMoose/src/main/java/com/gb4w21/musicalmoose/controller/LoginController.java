...
/**
 * the login controller that's responsible for login in both a client and a
 * manager and signing them out
 *
...
public class LoginController implements Serializable {
    ...
    /**
     * sings the user out and returns them back to their previous page back to
     * the index page if the user was a manager
     *
     * @author Alessandro Dare
    ...
    /**
     * Validates if the user login information was correct and the information
     * wasn't from a deactivated or false account
     *
     * @author Alessandro Dare
     * @param context
     * @param component
