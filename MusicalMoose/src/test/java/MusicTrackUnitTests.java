...
public class MusicTrackUnitTests {
    ...
    @Inject
    private MusicTrackJpaController fab;
    ...
    public void testFindMostRecentTracks() throws SQLException {
        int trackCount = fab.findMostRecentTracks().size();
    ...
    public void testFindRelatedTracks() throws SQLException {
        MusicTrack track = fab.findMusicTrack(1);
        List<MusicTrack> tracksInSameAlbum = fab.findAllRelatedTracks(track);
    ...
    public void testGetSpecialTracks() {
        List<MusicTrack> specialTracks = fab.getSpecialTracks();
        boolean checkConditions = true;
